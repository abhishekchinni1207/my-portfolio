...
const Education = () => {
  ...
  const education = [
    {
      institution: "CCBP Intensive 4.0 Tech Program",
      degree: "NA",
      field: "Full Stack Web Development",
      period: "2024-2025"
    },
    {
      institution: "Arni University, Kangra, Himahcal Pradesh",
  ...
  const achievements = [
    "Completed a Full Stack Web Development program at CCBP Intensive 4.0.",
    "Developed multiple personal projects showcasing web development skills.",
